* neteng_projects_nolocs
** 
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-network_engineer
#+OPTIONS: toc:nil
*** Justin Knox, B.Sc., CC
--------
#+OPTIONS: toc:nil
...
***** Studying for Masters of Science in Computer Science | Dec 2022 - Present
...
***** IT & Network Systems Design, Deployment & Support | March 2023 – June 2023
****** Implement and scale Managed IT Services, support and design for all levels of technical operations and infrastructure.
****** Services include Network Management, Security analysis, production acquisition and integration, CAT6 & Fiber networking, Wireless Access Controllers, back-haul repeaters, Wireless (CDMA, LTE & MIMO) antennas, IP Cameras & NVR systems.
#+begin_src latex :results output raw
\\
\\
#+end_src
...
***** Full-stack Development, Systems Architecture & Design | Dec 2021 – March 2023
...
\end{wrapfigure}
#+end_src
**** Google | Operations Engineer II
***** Global & 3^rd Party Datacenter, Engineering Field Services, Hardware, Network & Server Operations | Dec 2018 – Dec 2021
   - Coordinated deployment between Network, Hardware, Systems and Software Engineering teams to deploy full life cycle implementations, from schematic to deployment.
   - Deployed, maintained and configured the Cisco and Juniper (3rd party vendor) network infrastructure to the Google Cloud GCVE east coast deployment. The project was completed 60% faster than was scheduled.
...
\end{wrapfigure}
#+end_src
**** Switch LTD | Network Operations & Datacenter Technician
***** Network Operations | July 2017 - Dec 2018
  - Deployed customer network configurations, utilizing Palo-Alto, Juniper, Cisco, Cienna, Dell, HP, Checkmate, Alcatel-Lucent as well as other proprietary vendor equipment.
...
***** Information Technology | Oct 2016 - June 2017
  - Implemented company firewall policies over a blend of IP Tables, Cisco ASA, and Baraccuda network technologies.
  - Designed and implemented the companies network infrastructure using IPSEC over GRE on Cisco 2800 series ISRs, and 3600 series layer 2 switches.
  ...
  - Designed, built and implemented remote tunnels for locations over SSH tunneling.
  - Engineered, provisioned and migrated end-user PC's to security hardened internal Health management kiosks.
...
***** Technical Training & Documentation | Nov 2013 - April 2015
...
#+end_src
**** Alchemy Computing | Freelance Technical Consultant
***** Web Development, Computer Repair, Electronics Prototyping | Sept 2009 – Nov 2013
...
***** Global Operations Tier 3, Converged Services Management Center | May 2008 - Sept 2009
...
\end{wrapfigure}
#+end_src
**** DeVry University | Tutor & Laboratory Technician
***** Network Laboratory | Mar 2004 - June 2006
 - Tutored students in the network security and advanced micro peripheral courses.
...
**** Network Engineering & Assessment Tools:
...
**** "Video LAN Checker" - VOIP Security Camera Management
https://github.com/jknoxdev/video-lan-checker
***** Description:
...
* seceng_projects
** 
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-security_engineer.pdf
*** Justin Knox, B.Sc., CC
...
**** Alchemy Computing | Freelance Technical Consultant
***** Full-stack Development, Systems Architecture & Design | Ann Arbor, MI | Dec 2021 – Present
****** Services include, small business infrastructure design, development & deployment, full-stack development, wireless network design and server disaster recovery.
****** Notable clients are primarily in the legal, entertainment and construction industries.
#+begin_src latex :results output raw
\\
...
***** Torrance, California | June 2006 - Nov 2007
  ...
  - Designed and converted existing customer networks to support fail over resistant mesh network topology utilizing FHSS (frequency hopping spread spectrum) radios.
  - Developed and implemented software utilizing the embedded System on Chip encryption modules with AES256 to secure video over radio communications.
  - Used Kismet, Spectrum analyzers and custom built software to conduct wireless penetration testing to ensure communication security.
  - Developed and implemented IPSec on the Active Directory LAN intranet and secured it in a mixed windows Linux development environment.
  - Worked in the engineering team developing industrial SCADA radios for monitoring digital IO, 4-20ma sensor loops, PWM, and industrial video applications.
  - Designed, conducted and implemented quality assurance and field simulation testing for complete product range.
...
Nmap, Net Stumbler, Netcat, Kismet, Wireshark, Kali, ParrotOS, Slingshot, Pentoo Linux
**** Languages:
C, C++, Java, SQL, BASH, LaTeX, YACC, YAML, XML, HTML, CSS, JavaScript, Ruby, Python, Assembly
**** Cloud / Server / HyperVisor Operating Systems:
...
Scripts to aid the secruity camera installer, currently scans the network to detect any cameras, shows encrypted traffic status. Draws diagram of connections to router.
***** Technologies used:
LLaMA 7B, ChatGPT, Python, PostgreSQL, SQLLite, Azure, GCP, AWS, ARP, DNS, DHCP, RTSP, RTP*** Education:
...
* dev_projects
**                                                                   :export:
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-developer
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
****** Implement and scale Managed IT Services, support and design for all levels of technical operations and infrastructure.
****** Projects included creating full company database in PostgreSQL, Python based Network Management, Security analysis, production acquisition and integration.
#+begin_src latex :results output raw
\\
\\
#+end_src
...
**** Switch LTD | Datacenter Technician
***** Network Operations | Las Vegas, Nevada | July 2017 - Dec 2018
   - Developed an internal mail handling script utilizing AutoHotKey and JavaScript that would parse incoming help-desk email and collect it into assorted groups to aid in processing incoming ticket requests. 
...
***** Office of Academic Support and Instruction Services, Advanced Development Laboratory, Network Laboratory, Computer Laboratory, Electronics Laboratory | Long Beach, California | Mar 2004 - June 2006
 ...
 - Focused specialties included:
   ...
   - Senior Project I&II, Design and Implementation strategies
   - FA for Physics I, II
...
* dt
**  
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-datacenter_engineer
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
****** Provide installation, support & configuration for any type of SMB infrastructure & appliances; including, servers, network infrastructure, structured cabling, access controls, cameras, monitoring and alarm systems.
...
**** DeVry University | Academic Tutor
***** Office of Academic Support and Instruction Services, Advanced Development Laboratory, Network Laboratory, Computer Laboratory, Electronics Laboratory | Long Beach, California | Mar 2004 - June 2006
 - Worked closely with the IT department on campus to roll-out user profiles, administer accounts to new users, assist faculty with technical issues, and provide off hours support, deployment & reconfiguration for campus infrastructure.
...
* sysadm
** 
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-systems_administrator
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* inf_jpeg
** 
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-infrastructure_engineer
#+OPTIONS: toc:nil
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
...
****** Notable clients are primarily in the hospitality, retail, and food and beverage industries.
#+begin_src latex :results output raw
\\
\\
#+end_src
...
#+OPTIONS: toc:nil
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: +1 (843) 534-6040
--------
#+OPTIONS: toc:nil
#+OPTIONS: num:nil
#+GEOMETRY: margin=1.5cm
...
**** jPegDesign | Technical Specialist II
***** IT & Network Systems Design, Deployment & Support | Ann Arbor, MI | March 2023 – Present
****** Implement and scale Managed IT Services, support and design for all levels of technical operations and infrastructure.
****** Services include Network Management, Security analysis, production acquisition and integration, CAT6 & Fiber networking, Wireless Access Controllers, back-haul repeaters, Wireless (CDMA, LTE & MIMO) antennas, IP Cameras & NVR systems.
#+begin_src latex :results output raw
\\
...
**** Alchemy Computing | Freelance Technical Consultant
***** Full-stack Development, Systems Architecture & Design | Ann Arbor, MI | Dec 2021 – March 2023
****** Services include, small business infrastructure design, development & deployment, full-stack development, wireless network design and server disaster recovery.
****** Notable clients are primarily in the legal, entertainment and construction industries.
#+begin_src latex :results output raw
\\
...
* swe_projects
**                                                                   :export:
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-software_engineer
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
***** Office of Academic Support and Instruction Services, Advanced Development Laboratory, Network Laboratory, Computer Laboratory, Electronics Laboratory | Long Beach, California | Mar 2004 - June 2006
 ...
 - Focused specialties included:
   ...
   - Network Packet analysis
   - Cisco CLI commands, interfacing and scripting.
   - Implmenting network configurations with Java
...
* deskup
**
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-desktop_support_engineer
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
#+LATEX_CLASS_OPTIONS: [letter,10pt]
#+LATEX_HEADER: \usepackage[T1]{fontenc}
#+LATEX_HEADER: \renewcommand*\oldstylenums[1]{{\fontfamily{Montserrat-TOF}\selectfont #1}}
#+LATEX_HEADER_EXTRA: \usepackage{fontspec}
#+LATEX_HEADER_EXTRA: \setmainfont{FreeMono}
#+LATEX_HEADER: \usepackage[margin=1.5cm]{geometry}
#+LaTeX_CLASS: article
...
**    
#+OPTIONS: toc:nil
#+EXPORT_FILE_NAME: ./pdfs/justin_knox-embedded_software_engineer
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* gen
**   
#+EXPORT_FILE_NAME: ./pdfs/gen/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* infeng
** 
#+EXPORT_FILE_NAME: ./pdfs/infeng/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* invmgmt
** #+EXPORT_FILE_NAME: ./pdfs/invmgmt/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
--------
#+OPTIONS: toc:nil
#+OPTIONS: num:nil
...
* noc
** #+EXPORT_FILE_NAME: ./pdfs/noc/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* secan
** #+EXPORT_FILE_NAME: ./pdfs/secan/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* seceng
** #+EXPORT_FILE_NAME: ./pdfs/seceng/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* secops
** #+EXPORT_FILE_NAME: ./pdfs/secops/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* sre
**
#+EXPORT_FILE_NAME: ./pdfs/sre/justin_knox-site_reliability_engineer
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* sysadm
** 
#+EXPORT_FILE_NAME: ./pdfs/sysadm/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
* sysarch
** #+EXPORT_FILE_NAME: ./pdfs/sysarch/justin-knox_resume_2023
*** Justin Knox, B.Sc., CC
2232 S Main St. #292, Ann Arbor MI, 48103 | M: 313.466.2808
--------
#+OPTIONS: toc:nil
...
C, C++, Java, SQL, BASH, LaTeX, YACC, YAML, XML, HTML, CSS, JavaScript, Ruby, Python, Assembly
**** Cloud / Server / HyperVisor Operating Systems:
Windows 10, Windows 2016, RHEL 7, OSX, Debian, Gentoo, VMWare), ESXi, OpenBSD, FreeBSD, NetBSD, Docker, XCP-NG, EVE-NG, VirtualBox
**** Applications:
Office, SharePoint, Adobe Premiere, Adobe After Effects, Adobe Photoshop, Adobe Illustrator, MATLab, Slicer (3D Printing)
**** Databases:
PostreSQL, MS SQL Server 2008, MS Access, MySQL
...
* syseng
** 
#+EXPORT_FILE_NAME: ./pdfs/syseng/justin-knox_resume_2023
...
C, C++, Java, SQL, BASH, LaTeX, YACC, YAML, XML, HTML, CSS, JavaScript, Ruby, Python, Assembly
**** Cloud / Server / HyperVisor Operating Systems:
Windows 10, Windows 2016, RHEL 7, Macintosh OSX, SUSE Linux, Ubuntu, Debian, Gentoo, Pentoo, Knoppix, WMWare, ESXi, OpenBSD, FreeBSD, NetBSD, Docker, XCP-NG, EVE-NG, VirtualBox
**** Applications:
Office, SharePoint, Adobe Premiere, Adobe After Effects, Adobe Photoshop, Adobe Illustrator, MATLab, Slicer (3D Printing)
**** Databases:
PostreSQL, MS SQL Server 2008, MS Access, MySQL
