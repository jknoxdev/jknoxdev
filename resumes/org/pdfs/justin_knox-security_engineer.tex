...
\label{sec:org6e09a4d}
\section*{Experience:}
\label{sec:orgaa98dbf}
...
\label{sec:orgf50362d}
\subsubsection*{Full-stack Development, Systems Architecture \& Design | Ann Arbor, MI | Dec 2021 – Present}
\label{sec:orgd594664}
\begin{itemize}
...
\item Used Kismet, Spectrum analyzers and custom built software to conduct wireless penetration testing to ensure communication security.
...
\label{sec:orgcdb08d8}
\subsubsection*{Description:}
\label{sec:orgcdc215b}
